from vis_game.system.mainFunc import dict_game_for_player, load_data_per2
game_name_ = 'Catan_v2'
import random
import numpy as np
from vis_game._setup_ import game_name,time_run_game
...
from vis_game.base.Catan_v2.AgentFunc import *
